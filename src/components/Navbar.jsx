      ...
      <div className=' h-10 flex flex-row items-center '>
        <div className='w-[590px] bg-yt-black flex border border-yt-light-black items-center rounded-3xl h-10'>
          <input type="text" placeholder='search'
           className='w-full bg-yt-black h-5 ml-5 text-yt-white text-start focus:outline-none pl-4'
          />
          <button className='w-16 h-10 bg-yt-light-black px-2 py-8.5 rounded-r-3xl border-l-2 border-yt-light-black'>
            <HiMagnifyingGlass
            size={22}
        ...
        <div className='text-yt-white bg-yt-light w-10 h-10 items-center flex justify-center rounded-full ml-4 hover:bg-yt-light-black cursor-pointer'>
          <MdMic size={22} className='text-center'/>
        </div>
      </div>
      <div className='flex items-center justify-center'>
        <div className='flex flex-row items-center'>
          ...
          <div className='mx-2 p-2 w-10 hover:bg-yt-light-black rounded-full cursor-pointer'>
            <FaRegBell size={23.5} className='text-yt-white text-center' />
          </div>
          <div className='mx-3 items-center cursor-pointer'>
            {
              !user ? (<button className='bg-yt-red py-1 px-4 text-yt-white rounded-md'
                onClick={handleLogin}>
                 Sign In
                 </button>) : (<img src={user.photoURL}
